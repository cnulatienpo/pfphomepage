"""Stress test scripts/extract_block_glyph_candidates.py."""
...
SCRIPT_PATH = Path("scripts/extract_block_glyph_candidates.py")
...
def main() -> None:
    scenarios = [
        ...
        ("Incorrect file formats", True, {"cv2": cv2_stub("Bad image format")}, True, None, None),
        ("Empty files", True, {"cv2": cv2_stub("Empty image file")}, True, None, None),
