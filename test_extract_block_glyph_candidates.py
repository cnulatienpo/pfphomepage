...
TARGET_MODULE = "scripts.extract_block_glyph_candidates"
TARGET_LABEL = "extract_block_glyph_candidates.py"
...
def main() -> None:
    ...
    print("OK: extract_block_glyph_candidates.py ran without crashing")
